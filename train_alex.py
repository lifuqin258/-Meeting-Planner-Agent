...
if torch.cuda.is_available():
    model = model.cuda()
#model.load_state_dict(torch.load('G:\\model_fm\\vtn_ob_alex.pth'))
...
for epoch in range(200):
    ...
    torch.save(model.state_dict(), 'G:\\model_fm\\vtn_zz_alex.pth')
